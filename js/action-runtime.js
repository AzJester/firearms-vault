...
(function initVaultActions(global) {
  ...
  const ALLOWED = new Set([
    'addCustomField', 'applyCollectionHealthFixes', 'applyCrop', 'applyDataQualityCleanup', 'beginMfaEnrollment',
    'applyDealerFilter', 'approveQuickCaptureToReview', 'bulkAddTag', 'bulkRemoveTag', 'cancelMfaEnrollment', 'captureQuickCaptureSnapshot', 'captureSnapshot', 'changeCloudPassword',
    'checkDuplicateSerial', 'cleanUnusedMedia', 'clearAllFilters', 'clearAuditTrail', 'clearBulkSelection',
    'clearOneFilter', 'closeAccessoryModal', 'closeActivityCenter', 'closeAmmoModal', 'closeBackupModal',
    ...
    'closeCollectionHealth', 'closeModal', 'closePasswordModal', 'closeQRModal', 'closeQuickCaptureModal', 'closeReminders',
    'closeReportBuilder', 'closeReportPackageModal', 'closeSettingsModal', 'closeShareModal', 'closeShortcutsModal', 'closeSyncCenter',
    'closeWishlistModal', 'cmdkExec', 'cmdkHover', 'cmdkRender', 'copyShareLink', 'createShare',
    'ctxAdd', 'cycleWishlistPriority', 'decryptReportPackage', 'deleteAccessory', 'deleteAmmo', 'deleteDealer', 'disableIndependentBackup',
    ...
    'generateCustomReport', 'generateReportPackage', 'handleCSVImport', 'handleDocUpload', 'handleImageUpload',
    'handleImport', 'handlePasswordSubmit', 'handleQuickCaptureFile', 'handleReceiptUpload', 'handleStampUpload',
    'handleTagKey', 'importCSV', 'importDealersFromText', 'importJSON', 'loadAZDealers',
    'moveWishlistToCollection', 'openAccessoryModal', 'openActivityCenter', 'openAddAmmoModal', 'openAddModal',
    'openBackupFromSyncCenter', 'openBackupModal', 'openCameraModal', 'openCmdK', 'openCropModal',
    'openCollectionHealth', 'openDealerImportModal', 'openDealerModal', 'openDetail', 'openMaintenanceModal',
